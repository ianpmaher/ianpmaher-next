const projectsList = [
  {
    ...
    slug: "ri-api",
    description:
      "A RESTful API for Rhode Island data. Quantify anything in terms of RI data. Fun facts, statistics, and more!",
  ...
  },
  {
    ...
    slug: "simplyscholars",
    description:
      "A full-stack web application utilizing the Next.js & Strapi.js stack. This is a platform for the non-tech-savvy to build and maintain their own scholarship websites and databases. Providing customizability and ease of use, Simply Scholars is a tool for scholarship organizations to reach more students.",
  ...
  },
  {
    ...
    slug: "moodring",
    description:
      "A self-help app for healthier habits and safer schools. Full Stack CRUD application utilizing the 7 RESTful routes, Express.js, MongoDB, Mongoose, Embedded JavaScript, and node.js.",
    ...
    screenshot:
      "https://user-images.githubusercontent.com/120536234/270083592-2c66d8d6-2e0a-4e70-bd8e-1ddcaa97a358.png",
  },
  {
    id: 5,
