        ...
        <div className="mx-auto my-0 p-2 md:p-0 text-2xl">
            <div className="grid grid-cols-12 gap-4 w-fit">
                {blogPosts
                    ...
                    .map((post, index) => { // map over each post
                        const colSpan =
                            index % 3 === 0
                            ...
                            >
                                ...
                                <div>
                                    {post.tags.map((tag, index) => (
                                        <Link href={`/blog/${post.slug}`} key={index} className="underline even:decoration-dracula-green odd:decoration-dracula-orange underline-offset-4">
