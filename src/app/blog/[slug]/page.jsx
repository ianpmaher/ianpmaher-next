        ...
        <div className="px-8 py-12">
            ...
            <div className="prose lg:prose-xl text-justify whitespace-pre-line">
                ...
                <ReactMarkdown
                    ...
                    className="text-lg prose lg:prose-xl prose-a:underline prose-a:font-mono prose-a:text-xl hover:prose-a:text-blue-700 prose-h1:text-3xl prose-img:w-full prose-img:h-full md:prose-img:w-3/4 md:prose-img:h-3/4 "
                >
                    {postData.content}
                </ReactMarkdown>
            </div>
