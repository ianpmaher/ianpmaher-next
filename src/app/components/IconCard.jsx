const IconCard = ({ variant, description, children, className }) => {
    ...
    const variantStyle = {
        ...
        secondary: " bg-slate-100 p-0 hover:outline hover:outline-blue-400 shadow-2xl w-20 md:h-28 md:w-24 h-20 transition-none mr-4",
        ...
        text: "text-xl md:text-2xl mx-auto my-0 hover:text-dracula-sub dark:hover:text-dracula-orange",
    };
