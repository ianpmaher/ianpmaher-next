const IconCard = ({ variant, description, children, className }) => {
    ...
    const variantStyle = {
        ...
        secondary: " bg-slate-100 hover:scale-125 p-0 hover:outline hover:outline-blue-400 shadow-2xl w-32 md:h-32 h-24 transition-all duration-300 ease-out mr-4",
        ...
        darkColors: "bg-dracula-blue bg-opacity-70 hover:bg-dracula-green hover:bg-opacity-100 hover:scale-110 hover:transform hover:rotate-12 hover:shadow-2xl p-1",
        lightColors: "bg-dracula-purple bg-opacity-70 hover:bg-dracula-orange hover:bg-opacity-100 hover:scale-110 hover:transform hover:rotate-12 hover:shadow-2xl p-1",
    };
