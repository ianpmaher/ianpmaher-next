const CardBase = ({ variant, children, className }) => {
    const baseStyle = "";
    const variantStyle = {
        text: "mx-auto my-0 flex items-center justify-center text-paper-text bg-slate-200 shadow-lg dark:bg-black dark:text-dracula-text rounded-2xl text-base md:text-lg ",
        darkColors:
