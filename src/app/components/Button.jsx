const Button = ({ variant, children }) => {
    ...
    const variantStyle = {
        ...
        projects: "flex flex-col m-1 justify-center transition duration-500 items-center min-w-6 bg-[#EEA47F] color-[#00539C] text-sm p-0.5 outline outline-2 outline-[#00539C] hover:text-[#EEA47F] hover:bg-[#00539C] hover:outline-[#EEA47F] hover:scale-110",
    };
