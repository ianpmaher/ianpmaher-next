...
const NewNavMenu = (props) => {
  ...
  return (
    <NavigationMenu.Root className={props.className} delayDuration={100}>
      <NavigationMenu.List className="m-0">
        <NavigationMenu.Item className={`flex justify-center items-center outline w-[8vw] ${pathname === "/" ? "" : "invisible"}`}>
          <NavigationMenu.Trigger className=" ">
            <Link href="/#top" className={`link ${pathname === "/" ? "active" : ""}`}>
              <svg width="45" height="45" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={checkPathname}>
                <path
