                ...
                {/* <StyledComponentsRegistry> */}
                    <Providers>
                        ...
                        <div className="bg-gradientlight md:dark:bg-slice bg-fixed dark:bg-origin-border md:dark:bg-bottom dark:bg-cover pt-1 pb-24 dark:bg-phonedark">
                            <div className="dark:bg-dracula-bg bg-paper-bg bg-opacity-60 rounded-2xl text-paper-text dark:text-dracula-text font-karla text-center min-h-screen flex flex-col max-w-[80vw] my-0 mx-auto">
