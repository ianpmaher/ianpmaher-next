    ...
    <html lang="en" className="">
      ...
      >
        ...
        <Providers>
          ...
          <div className="bg-gradientlight md:dark:bg-slice bg-fixed dark:bg-origin-border md:dark:bg-bottom dark:bg-cover pb-2 md:pb-8 bermuda-bg bg-center">
            <div className="dark:bg-dracula-bg bg-paper-bg bg-opacity-90 rounded-2xl text-paper-text dark:text-dracula-text font-karla text-center min-h-screen flex flex-col max-w-[85vw] my-0 mx-auto">
